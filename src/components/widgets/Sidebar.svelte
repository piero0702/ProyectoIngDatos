    ...
    <ul class="sidebar-nav">
      ...
      <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
        <li class="sidebar-item">
          ...
          <a class="sidebar-link" href="/admin/body-part" on:click|preventDefault={() => {navigate('/admin/body-part')}}>
            Lista de partes del cuerpo
          </a>
          <a class="sidebar-link" href="/admin/members" on:click|preventDefault={() => {navigate('/admin/members')}}>
            Lista de miembros
          </a>
        </li>
        <li class="sidebar-item">
