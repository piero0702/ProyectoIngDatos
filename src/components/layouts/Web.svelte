...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="/" on:click|preventDefault={() => {navigate('/')}}>ULima</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/services" on:click|preventDefault={() => {navigate('/services')}}>Servicios</a>
        </li>
        <li class="nav-item">
