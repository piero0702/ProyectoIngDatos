<script>
    ...
    <div class="card border-0">
      <div class="card-header">
        <h5 class="card-title">
            Partes del Cuerpo de los Ejercicios
        </h5>
          ...
          <tbody>
            {#each levels as level}
              <tr>
                <td>{level.name}</td>
                <td>
                  <a href="/admin/level/edit/{level.id}" on:click|preventDefault={navigate(`/admin/level/edit/${levels.id}`)} class="btn btn-danger">Editar</a>
